...
Route::group(['middleware' => ['verified']], function () {
    ...
    //Payroll Export
    Route::get('export/payroll/bank/advice/report/{month}/{branch}/{department}/{employee}', [ReportController::class, 'PayrollBankAdviceReportExport'])->name('payroll.bank.advice.report.export');

    //Payroll Export
    Route::get('export/payroll/tire1/employee/report/{month}/{branch}/{department}/{employee}', [ReportController::class, 'PayrollTire1EmployeeReportExport'])->name('payroll.tire1.emp.report.export');
    
    //Payroll Export
    Route::get('export/payroll/tire2/employee/report/{month}/{branch}/{department}/{employee}', [ReportController::class, 'PayrollTire2EmployeeReportExport'])->name('payroll.tire2.emp.report.export');
