                    ...
                    <div class="card ">
                        <div class="card-body employee-detail-body fulls-card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold">{{ __('Country ID Card Number') }} :</strong>
                                        <span>{{ $employee->country_id }}</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold">{{ __('Social Security Number') }} :</strong>
                                        <span>{{ $employee->social_security_number }}</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold">{{ __('Employee Residency') }} :</strong>
                                        <span>{{ $employee->employee_residency }}</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold">{{ __('Secondary Employment') }} :</strong>
                                        <span>{{ $employee->secondary_employment }}</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold">{{ __('Non Cash Benefit') }} :</strong>
                                        <span>{{ \Auth::user()->priceFormat($employee->non_cash_benefit) }}</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold">{{ __('Bonus') }} :</strong>
                                        <span>{{ \Auth::user()->priceFormat($employee->bonus) }}</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold">{{ __('Bonus Type') }} :</strong>
                                        <span>{{ ucfirst($employee->bonus_type) }}</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold">{{ __('Third Tier') }} :</strong>
                                        <span>{{ \Auth::user()->priceFormat($employee->third_tier) }}</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold">{{ __('Deductible Reliefs') }} :</strong>
                                        <span>{{ \Auth::user()->priceFormat($employee->deductible_reliefs) }}</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold">{{ __('Initial Loan') }} :</strong>
                                        <span>{{ \Auth::user()->priceFormat($employee->initial_loan) }}</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold">{{ __('Loan Deduction Type') }} :</strong>
                                        <span>{{ ucfirst($employee->loan_deduction_type) }}</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold">{{ __('Loan Deduction') }} :</strong>
                                        @if ($employee->loan_deduction_type != 'percentage')
                                            <span>
                                                {{ \Auth::user()->priceFormat($employee->loan_deduction) }}
                                            </span>
                                        @else
                                            <span>{{ $employee->loan_deduction }}%
                                                ({{ \Auth::user()->priceFormat(($employee->loan_deduction * $employee->basic_salary) / 100) }})
                                            </span>
                                        @endif
                                ...
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold">{{ __('Severance Pay Paid') }} :</strong>
                                        <span>{{ \Auth::user()->priceFormat($employee->severance_pay_paid) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
