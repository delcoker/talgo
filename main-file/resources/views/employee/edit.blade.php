                                ...
                                <div class="row">
                                            ...
                                            <div class="d-flex radio-check">
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="secondary_employment_yes" value="yes" name="secondary_employment"
                                                        class="form-check-input"  {{ $employee->secondary_employment == 'yes' ? 'checked' : '' }}>
                                                    <label class="form-check-label "
                                                        for="secondary_employment_yes">{{ __('Yes') }}</label>
                                                </div>
                                                <div class="custom-control custom-radio ms-1 custom-control-inline">
                                                    <input type="radio" id="secondary_employment_no" value="no" name="secondary_employment"
                                                        class="form-check-input"  {{ $employee->secondary_employment == 'no' ? 'checked' : '' }}>
                                                    <label class="form-check-label "
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="bonus_type" class="form-control" required>
                                            ...
                                            <option value="taxable" @if($employee->bonus_type=='taxable') selected @endif>{{__('Taxable')}}</option>
                                            <option value="non-taxable" @if($employee->bonus_type=='non-taxable') selected @endif>{{__('Non Taxable')}}</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="loan_deduction_type" class="form-control" required>
                                            ...
                                            <option value="percentage" @if($employee->loan_deduction_type=='percentage') selected @endif>{{__('Percentage')}}</option>
                                            <option value="fixed" @if($employee->loan_deduction_type=='fixed') selected @endif>{{__('Fixed')}}</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        {!! Form::label('severance_pay_paid', __('Severance Pay Paid'), ['class' => 'form-label']) !!}<span class="text-danger pl-1">*</span>
                                        {!! Form::number('severance_pay_paid', old('severance_pay_paid'), [
                                            'class' => 'form-control',
                                            'required' => 'required',
