...
class EmployeeController extends Controller
{
    ...
    public function create()
    {
        if (\Auth::user()->can('Create Employee')) {
            $employee_residency=$this->employee_residency();
            ...
            return view('employee.create', compact('employee_residency','employees', 'employeesId', 'departments', 'designations', 'documents', 'branches', 'company_settings'));
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
    public static function employee_residency()
    {
        $arr=[1=>'Resident Full-Time',2=>'Non-Resident',3=>'Resident Part-Time',4=>'Resident - Casual'];
        return $arr;
    }
        ...
        if (\Auth::user()->can('Create Employee')) {
            ...
            $employee = Employee::create(
                [
                    ...
                    'employee_residency' => $request['employee_residency'],
                    'social_security_number' => $request['social_security_number'],
                    'secondary_employment' => $request['secondary_employment'],
                    'non_cash_benefit' => $request['non_cash_benefit'],
                    'bonus' => $request['bonus'],
                    'bonus_type' => $request['bonus_type'],
                    'third_tier' => $request['third_tier'],
                    'deductible_reliefs' => $request['deductible_reliefs'],
                    'initial_loan' => $request['initial_loan'],
                    'loan_deduction_type' => $request['loan_deduction_type'],
                    'loan_deduction' => $request['loan_deduction'],
                    'severance_pay_paid' => $request['severance_pay_paid'],
                    'created_by' => \Auth::user()->creatorId(),
                ]
    ...
    public function edit($id)
    {
        ...
        if (\Auth::user()->can('Edit Employee')) {
            ...
            return view('employee.edit', compact('employee_residency','employee', 'employeesId', 'branches', 'departments', 'designations', 'documents'));
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
    ...
    public function show($id)
    {
        ...
        if (\Auth::user()->can('Show Employee')) {
            ...
            $employee->employee_residency=$employee_residency=$this->employee_residency()[$employee->employee_residency];
            
            //     $employee     = Employee::find($empId);
            // $branch= Branch::where('created_by', \Auth::user()->creatorId())->get()->pluck('name', 'id');

            return view('employee.show', compact('employee_residency','employee', 'employeesId', 'branches', 'departments', 'designations', 'documents'));
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
